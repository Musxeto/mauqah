      ...
      <div  id="hunza" className="max-w-6xl mx-auto p-6 sm:p-12  lg:p-10">
        ...
        >
          ...
          <div className="mt-8">
            ...
            <motion.div className="video-container  shadow-black shadow-2xl flex justify-center items-center mt-4 overflow-hidden ">
              <video
                controls
                className="w-full md:w-3/4 h-fell bg-slate-200 object-cover rounded-lg "
          ...
          <div className="mt-8">
            ...
            <motion.div className="video-container  shadow-black shadow-2xl flex justify-center items-center mt-4 overflow-hidden ">
              <video
                controls
                className="w-full md:w-3/4 h-full bg-slate-200 object-cover rounded-lg "
          ...
          <div className="mt-8">
            ...
            <motion.div className="video-container flex justify-center items-center mt-4 overflow-hidden ">
              <video
                controls
                className="w-full bg-slate-200 shadow-black shadow-2xl lg:w-3/4 h-auto rounded-lg "
